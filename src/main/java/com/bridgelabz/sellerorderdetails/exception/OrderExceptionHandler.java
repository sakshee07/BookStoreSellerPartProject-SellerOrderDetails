package com.bridgelabz.sellerorderdetails.exception;
...
public class OrderExceptionHandler {
    ...
    public ResponseEntity<ResponseDTO> handleBookStoreException(OrderException exception){
        ResponseDTO resDTO = new ResponseDTO("Exception while processing Order REST request", exception.getMessage());
